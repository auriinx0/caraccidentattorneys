export const es = {
    ...
    areas: {
        'car-accidents': {
            ...
            statistics: [
                "Más de 6 millones de accidentes automovilísticos ocurren en los EE. UU. anualmente.",
            ...
            whatToDo: [
                ...
                "Busque atención médica, incluso si se siente bien.",
                "Reúna pruebas: fotos de la escena, información de testigos.",
                "Intercambie información de seguro.",
                "NO dé una declaración grabada a la aseguradora del otro conductor.",
                "Llame a Car Accident Attorneys."
            ],
        ...
        'motorcycle': {
            ...
            statistics: [
                "Los motociclistas tienen 29 veces más probabilidades que los ocupantes de automóviles de morir en un accidente por milla recorrida.",
            ...
            whatToDo: [
                "Muévase a un lugar seguro si es posible.",
                "Llame a la policía y paramédicos.",
                "Conserve su casco y equipo como evidencia.",
        ...
        'commercial': {
            ...
            statistics: [
                "En 2021, 5,788 personas murieron en accidentes de camiones grandes.",
            ...
            whatToDo: [
                "Llame al 911.",
                "Obtenga el número CDL del conductor, nombre de la empresa y seguro.",
        ...
        'boating': {
            ...
            statistics: [
                "El consumo de alcohol es el principal factor contribuyente conocido en accidentes de navegación fatales.",
            ...
            whatToDo: [
                "Verifique si hay heridos y pida ayuda.",
                "Reporte el accidente a la Guardia Costera o autoridades locales.",
        ...
        'bus': {
            ...
            statistics: [
                "Los autobuses interurbanos representan el 13% de todas las muertes en autobuses.",
            ...
            whatToDo: [
                ...
                "Guarde su boleto de autobús o prueba de viaje.",
        ...
        'rideshare': {
            ...
            statistics: [
                "Hay más de 1 millón de conductores de viajes compartidos en los EE. UU.",
            ...
            whatToDo: [
                "Llame al 911.",
                "Tome una captura de pantalla de su estado de viaje en la aplicación.",
        ...
        'pedestrian': {
            ...
            statistics: [
                "En 2021, 7,388 peatones murieron en accidentes de tráfico en los EE. UU.",
                "Esto fue un aumento del 13% con respecto a 2020.",
                "Casi el 75% de las muertes de peatones ocurren en áreas urbanas."
            ],
            whatToDo: [
                "No abandone la escena.",
                "Llame al 911.",
                "Obtenga información del conductor y testigos.",
        ...
        'passenger': {
            ...
            statistics: [
                "Los pasajeros representan un porcentaje significativo de las lesiones por accidentes de vehículos.",
            ...
            whatToDo: [
                "Asegúrese de que se presente un informe policial.",
                "Obtenga información de seguro de todos los conductores involucrados.",
        ...
        'slip-fall': {
            ...
            statistics: [
                "Las caídas son la principal causa de visitas a la sala de emergencias, representando 8 millones de visitas al año.",
            ...
            whatToDo: [
                "Reporte el incidente al gerente de la propiedad inmediatamente.",
                "Pida una copia del informe del incidente.",
        ...
        'construction': {
            ...
            statistics: [
                "Los 'Cuatro Fatales' en la construcción son caídas, golpeado por objeto, electrocuciones, y atrapado en/entre.",
            ...
            whatToDo: [
                "Reporte la lesión a su supervisor inmediatamente.",
                "Busque ayuda médica.",
        ...
        'brain': {
            ...
            statistics: [
                "Hay aproximadamente 2.8 millones de visitas al departamento de emergencias relacionadas con TBI anualmente.",
            ...
            whatToDo: [
                "Busque atención médica inmediata para cualquier trauma en la cabeza.",
                "Monitoree síntomas como mareos, pérdida de memoria o cambios de humor.",
        ...
        'mesh': {
            ...
            statistics: [
                "La FDA ha recibido miles de informes de complicaciones por malla quirúrgica.",
            ...
            whatToDo: [
                "Consulte a su médico si experimenta dolor o complicaciones.",
        ...
        'hair': {
            ...
            statistics: [
                "Las mujeres que usaron alisadores de cabello al menos cada 8 semanas tenían un 4% más de probabilidades de desarrollar cáncer de útero.",
            ...
            whatToDo: [
                "Guarde recibos o prueba de compra de productos alisadores de cabello.",
        ...
        'roundup': {
            ...
            statistics: [
                "Los jurados han otorgado miles de millones de dólares en daños a las víctimas de Roundup.",
            ...
            whatToDo: [
                "Documente su exposición a Roundup (fechas, frecuencia, ubicación).",
        ...
        'talc': {
            ...
            statistics: [
                "J&J ha enfrentado más de 40,000 demandas relacionadas con productos de talco.",
            ...
            whatToDo: [
                "Documente su historial de uso de productos de talco.",
        ...
        'ozempic': {
            ...
            statistics: [
                "Los informes de parálisis estomacal han aumentado con la popularidad de los agonistas de GLP-1.",
            ...
            whatToDo: [
                "Busque atención médica para vómitos severos o dolor estomacal.",
        ...
        'truvada': {
            ...
            statistics: [
                "Los medicamentos TDF se han asociado con un aumento del 34% en el riesgo de insuficiencia renal.",
            ...
            whatToDo: [
                "Monitoree su función renal y densidad ósea con su médico.",
